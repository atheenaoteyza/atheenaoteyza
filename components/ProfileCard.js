...
export default function ProfileCard() {
  return (
    <div className="border border-zinc-200 dark:border-zinc-800 lg:h-[28rem] h-full overflow-y-auto rounded-xl bg-white dark:bg-[hsl(0,0%,0%)] font-mono text-sm leading-relaxed whitespace-pre-wrap">
      <div className="mb-4 relative w-fit group p-[1rem]">
        ...
        <div className=" absolute bottom-4 left-4 flex items-center gap-2 p-1.5 px-3 rounded-full shadow-sm border border-white/20 dark:border-black/20">
          ...
          {/* The Text */}
          <span className="text-[10px] font-bold tracking-wide text-gray-200 whitespace-nowrap">
            Committed full time
          </span>
        </div>
      </div>
      ...
      <div className="pb-[1rem] px-[1rem]">
        Hi! I am a{" "}
        <span className="font-bold text-[#3c6f9a] dark:text-blue-400">
